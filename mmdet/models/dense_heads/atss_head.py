...
class ATSSHead(AnchorHead):
    ...
    def __init__(self,
                 ...
                 loss_centerness=dict(
                     ...
                     use_sigmoid=True,
                     loss_weight=1.0),
                 loss_depth=dict(type="DepthLoss", loss_weight=1),
                 init_cfg=dict(
                     type='Normal',
                     layer='Conv2d',
                     std=0.01,
        ...
        Returns:
            tuple: Usually a tuple of classification scores and bbox prediction
                ...
                bbox_preds (list[Tensor]): Box energies / deltas for all scale
                    ...
                    num_anchors * 4.
        """
        temp = multi_apply(self.forward_single, feats, self.scales)
        # print(type(temp))
        return temp
    ...
    def loss(self,
        ...
        Args:
            ...
            clsloss (bool) : whether use the loss of cls
        ...
        if depth != None:
            self.loss_depth.give_img(img_metas)
            loss_depth = self.loss_depth(depth, gt_bboxes[0], device)
            # loss_depth = self.depth_detach(loss_depth)
            return dict(
                loss_cls=losses_cls,
